  ...
  table do 
    ...
    actions do |toolbar, instance, admin|
      if instance.withdraw? && instance.pending?
        toolbar.link "Approve", admin.path(:approve, id: instance.id), method: :post, style: "success"
        toolbar.link "Reject", admin.path(:reject, id: instance.id), method: :post, style: "danger"
      end
    end
  end
